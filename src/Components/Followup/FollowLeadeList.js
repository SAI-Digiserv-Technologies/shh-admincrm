...
import { followupleadsList, leadsList, leadstatus } from "../../Data/DummyJson";
import ArrowBackIosNewOutlinedIcon from "@mui/icons-material/ArrowBackIosNewOutlined";
import ArrowForwardIosOutlinedIcon from "@mui/icons-material/ArrowForwardIosOutlined";
import ArrowDropDownIcon from "@mui/icons-material/ArrowDropDown";
import { useNavigate } from "react-router-dom";

const FollowLeadeList = () => {
  ...
  const currentLeads = followupleadsList.slice(
    indexOfFirstLead,
    indexOfLastLead
  );
  const totalPages = Math.ceil(followupleadsList.length / leadsPerPage);
              ...
              >
                ...
                >
                  <div className="d-flex ac-jc gap-3">
                    <button
                      onClick={() => {
                        navigate("/telecallers/followup/details", {
                          state: { type: "edit" },
                        });
                      }}
...
export default FollowLeadeList;
